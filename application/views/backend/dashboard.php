                  ...
                  <table id="recent-orders" class="table table-hover table-xl mb-0">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td class="text-truncate">
                          <span class="avatar avatar-xs">
                            <img class="box-shadow-2" src="<?php echo base_url();?>app-assets/images/portrait/small/avatar-s-4.png"
                            alt="avatar">
                          </span>
                        ...
                        <td class="text-truncate p-1">
                          <ul class="list-unstyled users-list m-0">
                            ...
                            class="avatar avatar-sm pull-up">
                              ...
                              src="<?php echo base_url();?>app-assets/images/portfolio/portfolio-1.jpg"
                              alt="Avatar">
                            </li>
                            ...
                            class="avatar avatar-sm pull-up">
                              <img class="media-object rounded-circle no-border-top-radius no-border-bottom-radius"
                              src="<?php echo base_url();?>app-assets/images/portfolio/portfolio-4.jpg"
                              alt="Avatar">
                            </li>
                      ...
                      <tr>
                        ...
                        <td class="text-truncate">
                          <span class="avatar avatar-xs">
                            <img class="box-shadow-2" src="<?php echo base_url();?>app-assets/images/portrait/small/avatar-s-5.png"
                            alt="avatar">
                          </span>
                          <span>Doris R.</span>
                        </td>
                        <td class="text-truncate p-1">
                          <ul class="list-unstyled users-list m-0">
                            ...
                            class="avatar avatar-sm pull-up">
                              <img class="media-object rounded-circle no-border-top-radius no-border-bottom-radius"
                              src="<?php echo base_url();?>app-assets/images/portfolio/portfolio-6.jpg"
                              alt="Avatar">
                            </li>
                            <li class="avatar avatar-sm">
                      ...
                      <tr>
                        ...
                        <td class="text-truncate">
                          <span class="avatar avatar-xs">
                            <img class="box-shadow-2" src="<?php echo base_url();?>app-assets/images/portrait/small/avatar-s-7.png"
                            alt="avatar">
                          </span>
                          <span>Andrew D.</span>
                        </td>
                      ...
                      <tr>
                        ...
                        <td class="text-truncate">
                          <span class="avatar avatar-xs">
                            <img class="box-shadow-2" src="<?php echo base_url();?>app-assets/images/portrait/small/avatar-s-9.png"
                            alt="avatar">
                          </span>
                          <span>Walter R.</span>
                        </td>
                        <td class="text-truncate p-1">
                          <ul class="list-unstyled users-list m-0">
                            ...
                            class="avatar avatar-sm pull-up">
                              <img class="media-object rounded-circle no-border-top-radius no-border-bottom-radius"
                              src="<?php echo base_url();?>app-assets/images/portfolio/portfolio-3.jpg"
                              alt="Avatar">
                            </li>
                          </ul>
                        </td>
                        ...
                        <td>
                          <div class="progress progress-sm mt-1 mb-0 box-shadow-2">1
